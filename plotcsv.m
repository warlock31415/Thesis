...
%    "Pratik/20percent/RO4003S22.csv";"Pratik/10percent/RO4003S22.csv"];
...
ylabel("S11 (dB)");
grid on;
legend("Dry","5%","10%","20%",'FontSize',20,'Location','SouthEast');
%legend("Cotrol","Cement",'FontSize',20,'Location','SouthEast');
%legend("Control-Wet","Cement-Wet","Control-Dry","Cement-Dry",'FontSize',20,'Location','SouthEast');
ax = gca;
ax.FontSize = 25; 
grid on;
xlabel("Frequency (GHz)",'Fontsize',30);
ylabel("S_{11} (dB)","Fontsize",30);
xlim([0.5 5])
